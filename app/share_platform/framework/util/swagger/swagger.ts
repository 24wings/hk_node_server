...
export interface Parameter {
    ...
    required?: boolean;
    type: DataType;
    schema?: { $ref: string, type?: "array", items: { format: "int32", type: DataType } };
}
...
export type NewTObject = new () => Object;
export type DataType = "integer" | "string" | "float" | "date" | NewTObject;

export interface ApiServiceFile {
    tag: string,
    apis: { path: string, prop: PathProp }[]
}